...
public class ApiGameDTO {
    ...
    public ApiGameDTO(int gameNumber, boolean isGameWon, boolean isGameLost, int opponentPoints,
                      long numActiveOpponentForts, int[] lastOpponentPoints) {
    ...
    public static ApiGameDTO ApiGameDefault(int gameNumber, Game game) {
        return new ApiGameDTO(gameNumber, game.hasUserWon(), game.hasUserLost(),
                game.getEnemyPoints(), game.numActiveEnemies(), game.getLatestEnemyDamages());
    }
}
